...
```{sql}
SELECT COUNT(CASE WHEN school_name BETWEEN 'A' AND 'M' THEN 'a-m' ELSE NULL END) AS a_m_count,
       COUNT(CASE WHEN school_name BETWEEN 'N' AND 'Z' THEN 'n-z' ELSE NULL END) AS n_z_count
       FROM benn.college_football_players
